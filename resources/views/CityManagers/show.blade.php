        ...
        <div class="panel-body">
          ...
          <div class="row">
            ...
            <div class="col-md-8">
              ...
              <div class="row">
                <div class="col-md-6">
                  <span class="text-muted">National Id: {{$Mgr->national_id}}</span><br>
                  <span class="text-muted">Name:</span> {{$Mgr->user->name}}<br>
                  <span class="text-muted">Email:</span> {{$Mgr->user->email}}<br><br>
