                ...
                columns: [
                    ...
                    /* Show */ {
                        mRender: function (data, type, row) {
                            return '<center><a href="/GymManagers/'+row.id+'" class="table-delete btn btn-info" data-id="' + row.id + '">Show</a></center>'
                        }
                    },
                    /* EDIT */ {
                        mRender: function (data, type, row) {
                            return '<center><a href="/GymManagers/'+row.id+'/edit" class="table-edit btn btn-warning" data-id="' + row.id + '">Edit</a></center>'
                        }
                    },
                    ...
                    {
                        mRender: function (data, type, row) {
                            return '<center><a href="#" class="table-delete btn btn-warning" row_id="' + row.id + '" data-toggle="modal" data-target="#banpopup" id="ban_toggle">Ban</a></center>'
                        }
                    },
                    /* UnBan */
                    {
                        mRender: function (data, type, row) {
                            return '<center><a href="#" class="table-delete btn btn-success" row_id="' + row.id + '" data-toggle="modal" data-target="#unbanpopup" id="unban_toggle">UnBan</a></center>'
                        }
                    },
