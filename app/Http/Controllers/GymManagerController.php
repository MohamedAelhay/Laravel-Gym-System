...
class GymManagerController extends Controller
{
    ...
    public function getData()
    {
        ...
        $gymManager = GymManager::whereIn('gym_id', $this->cityGymsIds)->with('user', 'gym');
        return datatables()->of($gymManager)
            ->addColumn('city.name', function ($gymManager) {
                $gyms = Gym::with('city')->where('id', $gymManager->gym->id)->first();
